...
func Ducks() {
	...
	fmt.Println("Time after which 50% of the ducks are back:", SecondsToMinutes(ComputeTimeDucksBack(A, 50)))
	fmt.Println("Time after which 99% of the ducks are back:", SecondsToMinutes(ComputeTimeDucksBack(A, 99)))
